...
export function useDiscordNotifications() {
	...
	useEffect(() => {
		const handleInvoiceCreated = async (event: Event) => {
		...
		const handleInvoiceFunded = async (event: Event) => {
			const customEvent = event as CustomEvent;
		...
		const handleInvoiceReleased = async (event: Event) => {
			const customEvent = event as CustomEvent;
		...
		const handleInvoiceDisputed = async (event: Event) => {
			const customEvent = event as CustomEvent;
