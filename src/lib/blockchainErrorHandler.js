 ...
 */
export async function executeBlockchainTransaction(transactionFn, options = {}) {
 ...
 */
export function canRetryTransaction(error) {
    return error.retryable;
}
/**
 * Get appropriate action text based on error type
 */
export function getErrorActionText(error) {
    switch (error.type) {
        case 'user_rejected':
            return 'Try Again';
